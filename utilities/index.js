 ...
 ************************** */
Util.getNav = async function (reg, res, next) {
...
Util.buildInventoryDetail = async function (data) {
  let grid;
  if (data) {
    grid = '<div class="inv-detail-container">';
    grid += '<div class="img-container">';
    grid +=
      '<img src="' +
      data.inv_image +
      '" alt="Image of ' +
    ...
    grid += "<p><b>Classification:</b> " + data.classification_name + "</p>";
